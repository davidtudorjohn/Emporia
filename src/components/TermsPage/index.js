...
const TermsPage = () => (
  <div id="termsConditions">
    ...
    <p>
      ...
      manage your use of our website, Emporia accessible at Emporia.com. These
      Terms will be applied fully and affect to your use of this Website. By
      using this Website, you agreed to accept all terms and conditions written
      in here. You must not use this Website if you disagree with any of these
      Website Standard Terms and Conditions. Minors or people below 18 years old
      are not allowed to use this Website.
    </p>
    <br />
    <h4>Intellectual Property Rights</h4>
    <p>
      Other than the content you own, under these Terms, Emporia and/or its
      licensors own all the intellectual property rights and materials contained
      in this Website. You are granted limited license only for purposes of
    ...
    <p>
      ...
      Emporia may further restrict access by you to any areas of this Website,
      at any time, in absolute discretion. Any user ID and password you may have
      for this Website are confidential and you must maintain confidentiality as
      well.
    </p>
    <br />
    <h4>Your Content</h4>
    <p>
      ...
      this Website. By displaying Your Content, you grant Emporia a
      ...
      third-party's rights. Emporia reserves the right to remove any of Your
      Content from this Website at any time without notice.
    </p>
    <br />
    <h4>No warranties</h4>
    <p>
      This Website is provided "as is," with all faults, and Emporia express no
      representations or warranties, of any kind related to this Website or the
      materials contained on this Website. Also, nothing contained on this
      Website shall be interpreted as advising you.
    </p>
    <br />
    <h4>Limitation of liability</h4>
    <p>
      In no event shall Emporia, nor any of its officers, directors and
      ...
      contract. Emporia, including its officers, directors and employees shall
      not be held liable for any indirect, consequential or special liability
      arising out of or in any way related to your use of this Website.
    </p>
    <br />
    <h4>Indemnification</h4>
    <p>
      You hereby indemnify to the fullest extent Emporia from and against any
    ...
    <p>
      Emporia is permitted to revise these Terms at any time as it sees fit, and
    ...
    <h4>Assignment</h4>
    <p>
      Emporia is allowed to assign, transfer, and subcontract its rights and/or
    ...
    <p>
      These Terms constitute the entire agreement between Emporia and you in
