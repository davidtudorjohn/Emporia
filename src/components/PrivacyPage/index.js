...
const PrivacyPage = () => (
  <div id="privacyPolicy">
    ...
    <br />
    <p>
      This privacy policy ("policy") will help you understand how Emporia ("us",
      "we", "our") uses and protects the data you provide to us when you visit
      and use Emporia.com ("website", "service"). We reserve the right to change
    ...
    <p>
      Emporia is committed to securing your data and keeping it confidential.
      Emporia has done all in its power to prevent data theft, unauthorized
    ...
    <p>
      ...
      web pages you spend the most time on, and websites you visit). The data we
      collect by using cookies is used to customize our website to your needs.
      After we use the data for statistical analysis, the data is completely
      removed from our systems. Please note that cookies don't allow us to gain
      control of your computer in any way. They are strictly used to monitor
      which pages you find useful and which you do not so that we can provide a
      better experience for you. If you want to disable cookies, you can do it
      by accessing the settings of your internet browser. (Provide links for
      cookie settings for major internet browsers).
    </p>
    <br />
    <h4>Links to Other Websites</h4>
    <p>
      Our website contains links that lead to other websites. If you click on
      these links Emporia is not held responsible for your data and privacy
    ...
    <ul>
      ...
      <p>
        Emporia will not lease, sell or distribute your personal information to
